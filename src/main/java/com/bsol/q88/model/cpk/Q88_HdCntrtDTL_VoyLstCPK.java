...
public class Q88_HdCntrtDTL_VoyLstCPK implements Serializable{
	...
	public int hashCode() {
		...
		result = prime * result + ((voyage_SeqId == null) ? 0 : voyage_SeqId.hashCode());
		return result;
	}
	@Override
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Q88_HdCntrtDTL_VoyLstCPK other = (Q88_HdCntrtDTL_VoyLstCPK) obj;
		...
		if (vesselIdEncrypted == null) {
			...
			return false;
		if (voyage_SeqId == null) {
			if (other.voyage_SeqId != null)
				return false;
		} else if (!voyage_SeqId.equals(other.voyage_SeqId))
			return false;
		return true;
	}
