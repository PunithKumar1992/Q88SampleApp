...
public class Q88_VoyObj_Fixture_GradeCPK implements Serializable{
	...
	public int hashCode() {
		...
		result = prime * result + ((grade_SeqId == null) ? 0 : grade_SeqId.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Q88_VoyObj_Fixture_GradeCPK other = (Q88_VoyObj_Fixture_GradeCPK) obj;
		if (fixtureLst_SeqId == null) {
			...
			return false;
		if (grade_SeqId == null) {
			if (other.grade_SeqId != null)
				return false;
		} else if (!grade_SeqId.equals(other.grade_SeqId))
			return false;
		if (trans_Id == null) {
