...
public class Q88_VslRegDtl_ProfLst_NPPPCPK  implements Serializable{
	...
	public int hashCode() {
		...
		result = prime * result + ((nppp_SeqId == null) ? 0 : nppp_SeqId.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Q88_VslRegDtl_ProfLst_NPPPCPK other = (Q88_VslRegDtl_ProfLst_NPPPCPK) obj;
		if (npp_SeqId == null) {
			...
			return false;
		if (nppp_SeqId == null) {
			if (other.nppp_SeqId != null)
				return false;
		} else if (!nppp_SeqId.equals(other.nppp_SeqId))
			return false;
		if (trans_Id == null) {
