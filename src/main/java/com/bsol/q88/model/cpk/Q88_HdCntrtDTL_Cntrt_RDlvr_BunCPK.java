...
public class Q88_HdCntrtDTL_Cntrt_RDlvr_BunCPK implements Serializable{
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((rdlvrBunker_SeqId == null) ? 0 : rdlvrBunker_SeqId.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Q88_HdCntrtDTL_Cntrt_RDlvr_BunCPK other = (Q88_HdCntrtDTL_Cntrt_RDlvr_BunCPK) obj;
		if (rdlvrBunker_SeqId == null) {
			if (other.rdlvrBunker_SeqId != null)
				return false;
		} else if (!rdlvrBunker_SeqId.equals(other.rdlvrBunker_SeqId))
			return false;
